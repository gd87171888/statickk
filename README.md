...
- 🎓 **跟着弹模式** - 零基础学习模式，高亮提示+即时反馈，弹对才能继续
- 🎮 **游戏模式（最新！）** - 类似Synthesia/Piano Tiles的落键游戏，边玩边学，支持难度选择和成就系统
- 🔗 **统一导航** - 三大模式无缝切换，所有功能一站式体验
...
> 💡 更多使用技巧请查看 [功能整合使用指南](INTEGRATION-GUIDE.md)  
...
**建议：** 在移动浏览器中，可以将网页"添加到主屏幕"获得类似原生应用的体验。
